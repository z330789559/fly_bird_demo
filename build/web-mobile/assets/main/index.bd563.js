...
System.register("chunks:///_virtual/FlappyBirdLite.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './FBird.ts', './PoolManager.ts', './ScrollControl.ts', './FLevel.ts', './GameBase.ts', './FBGlobalData.ts', './GameResult.ts', './FBRecordManager.ts', './Countdown.ts', './LogManager.ts', './index.ts', './index2.mjs', './telegram-web.ts', './index.mjs', './ToolsView.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _asyncToGenerator, _regeneratorRuntime, cclegacy, _decorator, Prefab, Node, CCInteger, Label, Collider2D, Button, Contact2DType, input, Input, find, UITransform, KeyCode, FBird, PoolManager, ScrollControl, FLevel, GameBase, FBGlobalData, GameResult, FBRecordManager, FBAction, FBInputType, Countdown, LogManager, __webpack_exports__Address, __webpack_exports__GameFi, TonConnectUI, TelegramWebApp, WalletsListManager, ToolsView;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
      ...
      WalletsListManager = module.WalletsListManager;
    }, function (module) {
    ...
    execute: function () {
      ...
      var FlappyBirdLite = exports('FlappyBirdLite', (_dec = ccclass('FlappyBirdLite'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(ScrollControl), _dec8 = property(ScrollControl), _dec9 = property(FLevel), _dec10 = property(CCInteger), _dec11 = property(CCInteger), _dec12 = property(CCInteger), _dec13 = property(Label), _dec14 = property(Collider2D), _dec15 = property(Collider2D), _dec16 = property(GameResult), _dec17 = property(Countdown), _dec18 = property(Button), _dec19 = property(Label), _dec20 = property(Node), _dec21 = property(Node), _dec22 = property(ToolsView), _dec(_class = (_class2 = /*#__PURE__*/function (_GameBase) {
        ...
        function FlappyBirdLite() {
          ...
          _initializerDefineProperty(_this, "logo", _descriptor20, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "toolView", _descriptor21, _assertThisInitialized(_this));
                  ...
                  return _regeneratorRuntime().wrap(function _callee$(_context) {
                    while (1) switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        _this2._initTonUI(addressConfig);
                        _this2._rigesterEvent();
                      case 5:
                      case "end":
        ...
        _proto._initTonUI = /*#__PURE__*/function () {
          var _initTonUI2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(addressConfig) {
            var _this3 = this;
            var wm, wms, connector, wallets;
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                case 0:
                  this.toolView.node.active = false;
                  wm = new WalletsListManager();
                  _context2.next = 4;
                ...
                case 13:
                  this._cocosGameFi = _context2.sent;
        ...
        _proto.openModal = /*#__PURE__*/function () {
          var _openModal = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        ...
        _proto._rigesterEvent = function _rigesterEvent() {
          if (this.touchLayer) {
        ...
        _proto._loadLevel = function _loadLevel() {
          ...
          var data = {
            ...
            addScoreCb: function addScoreCb() {
              return _this5._addScore();
            },
            dieCb: function dieCb() {
              return _this5._onDead();
            },
            addCoinCb: function addCoinCb() {
              return _this5._addCoin();
            }
          };
          ...
          if (this.gameResult) {
            var data = {
              ...
              restartCb: function restartCb() {
                return _this6.resetGame();
              },
              homeCb: function homeCb() {
                return _this6.gameLoaded();
              },
              isShowButtons: true
            };
        ...
        writable: true,
        initializer: null
      }), _descriptor19 = _applyDecoratedDescriptor(_class2.prototype, "top", [_dec20], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor20 = _applyDecoratedDescriptor(_class2.prototype, "logo", [_dec21], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
      }), _descriptor21 = _applyDecoratedDescriptor(_class2.prototype, "toolView", [_dec22], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: null
...
System.register("chunks:///_virtual/main", ['./debug-view-runtime-control.ts', './telegram-web.ts', './FBCoin.ts', './FBGlobalData.ts', './FBRecordManager.ts', './FBird.ts', './FLevel.ts', './FPipe.ts', './FlappyBirdLite.ts', './GameResult.ts', './ResolutionAdjuster.ts', './ScrollControl.ts', './ToolsView.ts', './Main.ts', './GameBase.ts', './CameraFollowTarget2D.ts', './Countdown.ts', './FollowTarget.ts', './LogManager.ts', './PoolManager.ts', './Singleton.ts', './Utils.ts', './GlobalEvent.ts', './AudioManager.ts'], function () {
  return {
...
System.register("chunks:///_virtual/ToolsView.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './index.ts', './telegram-web.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _asyncToGenerator, _regeneratorRuntime, cclegacy, _decorator, Sprite, Label, assetManager, SpriteFrame, Texture2D, Component, __webpack_exports__Address, __webpack_exports__toNano, TelegramWebApp;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
