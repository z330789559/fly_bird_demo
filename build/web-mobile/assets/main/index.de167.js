...
System.register("chunks:///_virtual/FlappyBirdLite.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './FBird.ts', './PoolManager.ts', './ScrollControl.ts', './FLevel.ts', './GameBase.ts', './FBGlobalData.ts', './GameResult.ts', './FBRecordManager.ts', './Countdown.ts', './LogManager.ts', './index.ts', './index.mjs', './telegram-web.ts', './index2.mjs', './ToolsView.ts'], function (exports) {
